...
// Validation of Flight ID
boolean b=false;
 if(fid.getText().length()==3){
 b=true;
 }
 
// Validation of Arrival Time 
boolean b1=false; 
 if(((int)(atime.getText().charAt(0))==48 || 
(int)(atime.getText().charAt(0))==49) && (int)(atime.getText().charAt(1))<=57 
&& (int)(atime.getText().charAt(1))>=48){
 if(((int)(atime.getText().charAt(3))>=48 && 
(int)(atime.getText().charAt(3))<54) && (int)(atime.getText().charAt(4))<=57 && 
(int)(atime.getText().charAt(4))>=48){
 b1=true;
 }
 }else if(((int)(atime.getText().charAt(0))==50)&& 
(int)(atime.getText().charAt(1))<52 && (int)(atime.getText().charAt(1))>=48){
 if(((int)(atime.getText().charAt(3))>=48 && 
(int)(atime.getText().charAt(3))<54) && (int)(atime.getText().charAt(4))<=57 && 
(int)(atime.getText().charAt(4))>=48){
 b1=true;
...
// Validation of Departure Time 
boolean b2=false; 
 if(((int)(dtime.getText().charAt(0))==48 || 
(int)(dtime.getText().charAt(0))==49) && (int)(dtime.getText().charAt(1))<=57 
&& (int)(dtime.getText().charAt(1))>=48){
 if(((int)(dtime.getText().charAt(3))>=48 && 
(int)(dtime.getText().charAt(3))<54) && (int)(dtime.getText().charAt(4))<=57 
&& (int)(dtime.getText().charAt(4))>=48){
 b2=true;
 }
 }else if(((int)(dtime.getText().charAt(0))==50)&& 
(int)(dtime.getText().charAt(1))<52 && (int)(dtime.getText().charAt(1))>=48){
 if(((int)(dtime.getText().charAt(3))>=48 && 
(int)(dtime.getText().charAt(3))<54) && (int)(dtime.getText().charAt(4))<=57 
&& (int)(dtime.getText().charAt(4))>=48){
 b2=true;
